...
export const SETTINGS_INDEX: readonly IndexEntry[] = [
  ...
  { label: 'Track selection', section: 'dj-behaviour', card: 'Track selection', keywords: 'agentic shortlist local model variety' },
  { label: 'Agent deadline', section: 'dj-behaviour', card: 'Track selection', keywords: 'timeout seconds' },
  { label: 'Discovery rounds per pick', section: 'dj-behaviour', card: 'Track selection', keywords: 'steps tool loops' },
  { label: 'Shortlist passes', section: 'dj-behaviour', card: 'Track selection', keywords: 'controller discovery candidates' },
  { label: 'Request matching', section: 'dj-behaviour', card: 'Request matching', keywords: 'direct agentic compound listener request' },
  { label: 'Segments & Skills', section: 'dj-behaviour', card: 'Segments & Skills', keywords: 'direct agentic runtime tools' },
