...
export const FUNCTIONGEMMA_VALIDATION_SCENARIOS: readonly FunctionGemmaScenario[] = [
  ...
  },
  {
    ...
    stage: 'route',
    split: 'validation',
    description: 'A generic live autonomous moment must make one complete call from the V2-only offered set; any offered researcher is valid.',
    ...
    route: { firstCallOneOf: ['skill_news_v2', 'skill_curiosity_v2', 'skill_now_playing_dig_v2'] },
  },
  {
    id: 'segment.route.autonomous-vanilla-only',
    stage: 'route',
    split: 'validation',
    description: 'A generic live autonomous moment must make one complete call from the vanilla offered set; any offered researcher is valid.',
    prompt: 'Operational moment:\nDay: Tuesday. Broad air-time: evening.\nTrack on air: "Moon Signal" by Night Service\nRecent segment kinds already aired:\n- skill_weather (45m ago)\n\nChoose exactly one offered research function. Do not decide airtime or write the line.',
    tools: [segmentTool('skill_news'), segmentTool('skill_curiosity'), segmentTool('skill_now_playing_dig')],
    route: { firstCallOneOf: ['skill_news', 'skill_curiosity', 'skill_now_playing_dig'] },
  },
  {
    id: 'segment.route.autonomous-mixed',
    stage: 'route',
    split: 'validation',
    description: 'A generic live autonomous moment must make one complete call from a mixed offered set; any offered researcher is valid.',
    prompt: 'Operational moment:\nDay: Tuesday. Broad air-time: evening.\nTrack on air: "Moon Signal" by Night Service\n\nChoose exactly one offered research function. Do not decide airtime or write the line.',
    tools: [segmentTool('skill_now_playing_dig_v2'), segmentTool('skill_news'), segmentTool('skill_curiosity_v2')],
    route: { firstCallOneOf: ['skill_now_playing_dig_v2', 'skill_news', 'skill_curiosity_v2'] },
  },
  {
  ...
  {
    id: 'commit.exact-id-grounding',
    stage: 'commit',
    split: 'validation',
    description: 'The committed identifier must be copied exactly from the surfaced set.',
    prompt: 'Choose the only eligible surfaced candidate. Candidates: [{"id":"aB9kL2mN7pQ4rS8tU1vW3x","artist":"Signal Glass","energy":"medium"}].',
    tools: [done],
    commit: {
      surfacedIds: ['aB9kL2mN7pQ4rS8tU1vW3x'],
      acceptableIds: ['aB9kL2mN7pQ4rS8tU1vW3x'],
      preferredIds: ['aB9kL2mN7pQ4rS8tU1vW3x'],
      forbiddenIds: [],
    },
  },
  {
    id: 'commit.strict-playlist',
    stage: 'commit',
    split: 'validation',
    description: 'A strict pinned playlist is an eligibility boundary, not a soft musical suggestion.',
    prompt: 'This show has a strict pinned playlist. Only playlist members are eligible even when an outside candidate appears to match the mood. Candidates: [{"id":"pinned-01","source":"strict playlist","artist":"Harbour Static","energy":"medium"},{"id":"outside-01","source":"library","artist":"Harbour Static","energy":"medium"}].',
    tools: [done],
    commit: {
      surfacedIds: ['pinned-01', 'outside-01'],
      acceptableIds: ['pinned-01'],
      preferredIds: ['pinned-01'],
      forbiddenIds: ['outside-01'],
    },
  },
  {
    id: 'commit.recent-rotation',
    stage: 'commit',
    split: 'validation',
    description: 'A compatible candidate recently aired by the station loses to an equally suitable fresh choice.',
    prompt: 'Keep a warm mid-energy indie flow. Avoid recent station rotation when an equally compatible alternative exists. Candidates: [{"id":"recent-01","artist":"Paper Maps","lastPlayedHoursAgo":3,"energy":"medium"},{"id":"fresh-02","artist":"Lanterns","lastPlayedDaysAgo":28,"energy":"medium"}].',
    tools: [done],
    commit: {
      surfacedIds: ['recent-01', 'fresh-02'],
      acceptableIds: ['fresh-02'],
      preferredIds: ['fresh-02'],
      forbiddenIds: ['recent-01'],
    },
  },
  {
    id: 'commit.host-over-guest-influence',
    stage: 'commit',
    split: 'validation',
    description: 'A host’s soft musical leaning wins a close tie over the weaker guest nudge.',
    prompt: 'All candidates meet show and rotation rules. Host editorial influence: melodic electronic pop. Guest nudge: hushed acoustic folk. Use the guest only as a weaker tie-breaker after the host. Candidates: [{"id":"host-01","style":"melodic electronic pop","artist":"Neon Vale"},{"id":"guest-01","style":"hushed acoustic folk","artist":"Moss Line"}].',
    tools: [done],
    commit: {
      surfacedIds: ['host-01', 'guest-01'],
      acceptableIds: ['host-01'],
      preferredIds: ['host-01'],
      forbiddenIds: ['guest-01'],
    },
  },
  {
    id: 'commit.deliberate-contrast',
    stage: 'commit',
    split: 'validation',
    description: 'An explicit programme lift permits more than one defensible step rather than one brittle golden track.',
    prompt: 'The show is deliberately lifting from a quiet opener into a brighter late-morning run. Choose a compatible, measured energy step; do not stay flat. Candidates: [{"id":"lift-01","energy":"medium","style":"bright indie pop"},{"id":"lift-02","energy":"medium","style":"soulful dance"},{"id":"flat-01","energy":"low","style":"sleepy acoustic"}].',
    tools: [done],
    commit: {
      surfacedIds: ['lift-01', 'lift-02', 'flat-01'],
      acceptableIds: ['lift-01', 'lift-02'],
      forbiddenIds: ['flat-01'],
    },
  },
];
