...
import {
  ...
  djHandoffTimingSchema,
  djHandoffMaxWaitMinutesSchema,
...
export const SETTINGS_PATCH_SCHEMAS: Readonly<Partial<Record<SettingsPatchKey, SettingsPatchEntry>>> = {
  ...
  djHandoffTiming: djHandoffTimingSchema,
  djHandoffMaxWaitMinutes: djHandoffMaxWaitMinutesSchema,
