...
interface DjAgentOptions {
  ...
  // Optional caller-owned nested diagnostic object. It is retained by
  // reference in the call ring so a final queue guard can fill its verified
  // outcome after the model call has been recorded.
