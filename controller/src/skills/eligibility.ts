// Per-skill eligibility — the two rules that answer "may this skill air right
...
// is an explicit operator action — so both owe the same two answers.
//
...
// Both rules at once. `reason` is for the booth log — the cron path is silent
